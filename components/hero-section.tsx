                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <TextEffect
                                    ...
                                    speedSegment={0.3}
                                    as="h1"
                                    className={cn("mx-auto mt-8 max-w-4xl text-balance text-5xl max-md:font-semibold md:text-7xl lg:mt-16 xl:text-7xl", openSauce.className)}>
                                    Your go to place for hacktoberfest projects.
                                </TextEffect>
                                {/* <HacktoberFestLogo /> */}
                                <TextEffect
                                    per="line"
                                ...
                                <AnimatedGroup
                                    ...
                                    <Button
                                        ...
                                        <Link href="https://github.com/arpy8/hackprojects">
                                            <span className="text-nowrap">Source Code</span>
                                        </Link>
                                    </Button>
                                </AnimatedGroup>
                            </div>
